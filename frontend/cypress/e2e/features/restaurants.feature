Feature: Restaurants
  ...
  Scenario: Atualização de um restaurante
      ...
      And o usuário atualiza o campo "Nome" para "Jonas Burguer" 
      And clica no botão "Salvar"
      Then o usuário deve ver o restaurante atualizado com nome "Jonas Burguer" na lista de restaurantes

  Scenario: Criação de um restaurante com nome já existente
      Given o usuário admin está na rota "restaurants/admin"
      And existe o restaurante de nome "Jonas Burguer"
      When o usuário clica no botão de criar restaurante "Criar restaurante"
      And O usuário preenche o campo "Nome" com "Jonas Burguer", "Endereço" com "Rua 123", "Horário de fechamento" com "1970-01-01T00:00:00.000Z" e "Tipo" com "Hamburgueria"
      And clica no botão "Salvar"
